...
class RankingPageState extends State<RankingPage> {
  ...
  final List<String> menuRank = <String> ["돈가스","스팸마요덮밥","김치볶음","소고기미역국","오삼불고기"];
              ...
              ToggleButtons(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Text('주간',style: GoogleFonts.doHyeon(fontSize: 15)),
                  ),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 16.0),
                    child: Text('월간',style: GoogleFonts.doHyeon(fontSize: 15)),
                  ),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 16.0),
                    child: Text('연간',style: GoogleFonts.doHyeon(fontSize: 15)),
                  ),
                ]
              ),
              SizedBox(
                      ...
                      child: Row(
                        ...
                        children: <Widget> [
                          Container(
                            ...
                            width: 40,
                            child: Text("$rank", style: GoogleFonts.doHyeon(fontSize: 20, color: Colors.white),),
                            color: Colors.amber.shade400,
                          ),
                          Expanded(
                            child: Container(
                              alignment: Alignment.center,
                              child: Text(menuRank[i], style: GoogleFonts.doHyeon(fontSize: 20),),
                            )
                          ),
                          Row(
                            children: <Widget>[
